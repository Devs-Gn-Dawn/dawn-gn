...
final class Version20250213200848 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `character` (id INT AUTO_INCREMENT NOT NULL, fk_user INT NOT NULL, name VARCHAR(127) NOT NULL, description LONGTEXT NOT NULL, background LONGTEXT NOT NULL, class VARCHAR(31) NOT NULL, faction VARCHAR(31) NOT NULL, xp_skill INT NOT NULL default 20, xp_gear INT NOT NULL default 10, note_orga LONGTEXT NOT NULL, INDEX IDX_937AB0341AD0877 (fk_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(127) NOT NULL, email VARCHAR(127) NOT NULL, roles VARCHAR(31) NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
