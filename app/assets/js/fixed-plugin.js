...
var logoColor = document.querySelector("#logoDawn");

var transparentBtn = document.querySelector("[transparent-style-btn]");
var whiteBtn = document.querySelector("[white-style-btn]");

var non_active_style = ["bg-none", "bg-transparent", "text-gray-900", "border-gray-900"];
var active_style = ["bg-gradient-to-tl", "from-gray-900", "to-slate-800", "bg-gray-900", "text-white", "border-transparent"];
...
if (pageName != "rtl") {
  ...
  window.addEventListener("click", function (e) {
    ...
    if (!fixedPlugin.contains(e.target) && !fixedPluginButton.contains(e.target)) {  
...
function sidebarColor(a) {
  ...
  var color_logo_from = a.getAttribute("data-color-logo");
  ...
  // logoColor.setAttribute('fill', "fill-" + activeColorFrom);
  ...
  logoColor.setAttribute('fill', color_logo_from);
}
